...
**동물 퀴즈 대회(School Quiz)**(이하 '본 서비스')은(는) 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
...
- **서비스 제공**: 퀴즈 콘텐츠 제공, 과제 제출 및 기록 저장, 학습 이력 관리
...
- **해킹 등에 대비한 기술적 대책**: 보안 인증을 획득한 전문 클라우드 플랫폼(Google Firebase, Vercel)을 기반으로 운영되며, 전 구간 보안 통신(HTTPS)을 사용하여 데이터를 암호화하여 전송합니다. 
- **개인정보 취급 직원의 최소화**: 개인정보를 처리하는 담당자를 개발 교사(팀) 1인으로 지정하여 접근 권한을 관리합니다. 
...
- **성명**: School Quiz 개발팀 (담당 교사)
- **소속**: School Quiz 운영위원회
- **직위**: 교사
- **연락처**: 학교 교무실 내선 번호 (※ 개인정보보호를 위해 교사의 개인 휴대전화 번호는 기재하지 않습니다.)

## 제9조 (개인정보 처리방침 변경)
이 개인정보 처리방침은 서비스 배포일로부터 적용됩니다.
